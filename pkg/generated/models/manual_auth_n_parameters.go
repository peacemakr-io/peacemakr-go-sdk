...
// ManualAuthNParameters manual auth n parameters
// swagger:model ManualAuthNParameters
...
func (m *ManualAuthNParameters) validatePublicKey(formats strfmt.Registry) error {
